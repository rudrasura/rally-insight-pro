    ...
    <footer className="bg-primary/5 border-t border-border py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-4 max-w-md">
              Professional padel match analysis powered by AI. Transform your game with data-driven insights and personalized coaching recommendations.
            </p>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; 2024 PadelPro. All rights reserved. Built with precision for padel excellence.</p>
        </div>
      </div>
    </footer>
  );
